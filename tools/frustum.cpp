...
void Frustum::setup(GLfloat fov, GLfloat width, GLfloat height, GLfloat near, GLfloat far)
{
...
void Frustum::lookAt(Vertex3f &eye, Vertex3f &center, Vertex3f &up)
{
    Vertex3f nc,fc,x,y,z;
...
bool Frustum::pointInFrustum(const Vertex3f &p) const {
