...
Sphere::Sphere(Vertex3<float> center, float radius)
{
    this->center=center;
    this->radius=radius;
}

void Sphere::set(Vertex3<float> center, float radius)
{
    this->center=center;
    this->radius=radius;
}
...
Vertex3<float> Sphere::intersection(const Vertex3<float> &start, const Vertex3<float> &end)
{/*
    float a,b,c;
    ...
    //Vertex3d ret=end;
    Vertex3<double> v(end[0]-start[0],end[1]-start[1],end[2]-start[2]);
    Vertex3<double> ret(end[0],end[1],end[2]);
    double a,b,c;
    ...
    return Vertex3<float>(ret[0],ret[1],ret[2]);
}
...
bool Sphere::inside(Vertex3<float> point)
{
    point-=center;
...
const Vertex3<float> &Sphere::getPosition() const
{
    return center;
}
