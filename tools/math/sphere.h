...
public:
    Sphere();
    Sphere(Vertex3<float> center,float radius);
    /**
     * @brief set Set matrix paramethers.
     * @param center
     * @param radius
     */
    void set(Vertex3<float> center,float radius);
    void set(float x,float y,float z,float radius);
    Vertex3<float> intersection(const Vertex3<float> &start, const Vertex3<float> &end);
    /**
     ...
     * @return
     */
    bool inside(Vertex3<float> point);
    /**
     ...
     * @return
     */
    const Vertex3<float> &getPosition() const;
private:
    Vertex3<float> center;
    float radius;
};
