...
public:
    ...
    void setAngle(const Vertex3f &value);

    void setOffsetPosition(const Vertex3f & position);
    void setOffsetAngle(const Vertex3f & angle);
    ...
    const char * getName();
    /**
     * @brief select Select model.
     */
    void select();
    /**
     * @brief deselect Deselect model.
     */
    void deselect();
    bool isSelected();
