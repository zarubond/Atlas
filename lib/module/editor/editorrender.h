...
class EditorRender: public ModuleRender
{
public:
    EditorRender();
    bool init();
...
private:
    void renderBox(WorldGraphics *world, const Matrix4f &mvp);
    void renderNavigator(EditorGraphics *editor, const Instrument *navig, const Matrix4f &mvp);
    void renderPositioning(EditorGraphics *editor, const Matrix4f &mvp);
    void renderScale(EditorGraphics *editor, const Matrix4f &mvp);
