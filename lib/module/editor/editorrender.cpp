...
bool EditorRender::init()
{
    loadShader();
    return true;
}

void EditorRender::render(WorldGraphics *world, const Environment *envi, const Matrix4f &mvp, unsigned int elapsed)
{
    if(!world->editor.isVisible()) return;

    renderNavigator(&world->editor,world->editor.navig, mvp);
    renderBox(world, mvp);
...
void EditorRender::renderPrev(WorldGraphics *world, const Environment *envi, const Camera &camera, unsigned int elapsed)
{
...
void EditorRender::loadBox(EditorGraphics * editor)
{
...
void EditorRender::loadNavigatorSphere(EditorGraphics * editor)
{
...
void EditorRender::loadNavigatorCube(EditorGraphics *editor)
{
...
void EditorRender::loadPosition(EditorGraphics * editor)
{
...
void EditorRender::loadScale(EditorGraphics *editor)
{
...
bool EditorRender::loadShader()
{
    ...
    const char * vertex_src =
            ...
            "void main(void) {\n"
            "   f_coord=(coord*dir)*scale+pos;\n"
            "   f_color=color;\n"
            "   gl_Position = mvp * vec4(f_coord,1.0);\n"
            "}\n";
    ...
    const char * fragment_src =
            ...
            "   gl_FragData[1] = encode(vec3(0.0,0.0,0.0));\n"
...
void EditorRender::renderNavigator(EditorGraphics * editor, const Instrument * navig, const Matrix4f &mvp)
{
...
void EditorRender::renderBox(WorldGraphics * world, const Matrix4f &mvp)
{
...
void EditorRender::renderPositioning(EditorGraphics *editor, const Matrix4f &mvp)
{
    ...
    else if(editor->axis.type()==EditorPositioning::ROTATION)
    {
//TBD
    }
