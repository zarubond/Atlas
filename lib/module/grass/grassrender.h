 ...
 */
class GrassRender: public ModuleRender, OpenGL
{
public:
    GrassRender();
    ...
    void render(GrassGraphics * base, const Environment *envi, const Matrix4f &mvp,unsigned int elapsed);
    void renderShadow(GrassGraphics *base, const Environment *envi, const Matrix4f &mvp, unsigned int elapsed);
