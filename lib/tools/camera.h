...
public:
	 ...
	 */
    void perspective(float view_angle, float width, float height, float near, float far);
    void perspective(Matrix4f & proj);
	/**
	 * @return Camera view matrix.
     */
    const Matrix4f & perspectiveLook() const;
    Matrix4f infinitePerspectiveLook() const;
    Matrix4f orthoLook() const;
     ...
     */
    Vector3f unproject(int x, int y, float depth) const;
