...
TerrainActionIncrease::TerrainActionIncrease(const TerrainControl *terrain):TerrainAction(terrain)
{
}

bool TerrainActionIncrease::repeat()
{
    return true;
}

bool TerrainActionIncrease::makeShadowTerrain()
{
    return false;
}

void TerrainActionIncrease::make(int x, int y, int z, float value, float fase, float opacity, unsigned char texture_v, unsigned char texture_h)
{
    if(value>0) return;
